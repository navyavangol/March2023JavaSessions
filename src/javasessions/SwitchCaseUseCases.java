...
public class SwitchCaseUseCases {
	...
	public static void main(String[] args) {
		...
		case "home":
			...
			break;
		case "car":
			System.out.println("car loan granted");
			break;
		case "education":
			System.out.println("education loan granted");
			break;
		case "personal":
			System.out.println("personal loan granted");
			break;
		default:
			System.out.println("pass the valid loan type...." + loanType);
			break;
		}
